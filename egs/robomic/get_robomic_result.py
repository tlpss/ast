...
if __name__ == '__main__':
    ...
    std_dev = np.std(acc_fold[:-1])
    print('The standard deviation of 5 folds is {:.3f}'.format(std_dev))
    print('The best epoch over all folds combined is {:d}'.format(best_epoch))
